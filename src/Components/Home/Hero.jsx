    ...
    return (
        <div className="w-full h-[130vh] md:h-[90vh] flex flex-col lg:flex-row">
            <div className="w-full lg:w-1/2 flex flex-col justify-between">
                <div className="w-[90%] md:w-[80%] mx-auto mt-7 flex flex-col justify-evenly md:justify-between h-[85vh] md:h-screen">
                    <div className="flex flex-col gap-4 font-light">
                        <h1 className="text-2xl">Strategic <span className="text-red-800">Legal Solutions</span> for Today&apos;s Challenges</h1>
                        ...
                        <button className="p-3 bg-red-800 text-white w-[40%] font-extralight">
                            See Services
                        </button>
                    </div>
